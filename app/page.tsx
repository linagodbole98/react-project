...
const Header = () => {
  return (
    <header className="flex justify-between items-center px-8 py-4">
      <h1 className="text-2xl font-bold">FLOR</h1>
      <nav>
...
const HeroSection = () => {
  return (
    <section className="h-screen bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: 'url(/path/to/your/hero-image.jpg)' }}>
      <div className="text-center text-white bg-opacity-50 p-8 rounded-md">
        <h2 className="text-4xl font-bold mb-4">Custom Dried Flower Bouquets</h2>
        <p className="text-lg mb-6">Free shipping, every occasion, every season.</p>
        <button className="px-6 py-3 bg-beige rounded-lg text-gray-800 font-semibold">Shop Now</button>
      </div>
    </section>
  );
};
...
const services = [
  { title: 'Custom Bouquets', description: 'Personalized flower arrangements.', image: '/path/to/image1.jpg' },
  { title: 'Occasion Flowers', description: 'Perfect for any occasion.', image: '/path/to/image2.jpg' },
  { title: 'Pre-made Bouquets', description: 'Handcrafted and ready to go.', image: '/path/to/image3.jpg' },
];
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div key={index} className="bg-white rounded-lg shadow-md p-6">
            <img src={service.image} alt={service.title} className="h-40 w-40 mx-auto mb-4 rounded-full" />
...
const popularItems = [
  { image: '/path/to/item1.jpg', name: 'Bouquet 1' },
  { image: '/path/to/item2.jpg', name: 'Bouquet 2' },
  { image: '/path/to/item3.jpg', name: 'Bouquet 3' },
  { image: '/path/to/item4.jpg', name: 'Bouquet 4' },
];

const PopularItemsSection = () => {
  return (
    <section className="py-16">
      <h2 className="text-3xl font-bold mb-8 text-center">See What’s Popular</h2>
  ...
  return (
    <section className="bg-beige py-16">
      <div className="text-center max-w-lg mx-auto">
        <h2 className="text-3xl font-bold mb-4">Talk To Our Staff</h2>
        <p className="text-gray-700 mb-8">We’d love to help you choose the perfect bouquet for your occasion.</p>
        <button className="px-6 py-3 bg-gray-800 text-white rounded-lg font-semibold">Contact Us</button>
      </div>
    </section>
  );
};
